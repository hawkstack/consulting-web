  ...
  return (
    <section className="w-full bg-[#FFFFFF] xl:py-18 xl:px-30">
      ...
      <div className="w-full mx-auto">
        <h2 className="text-6xl font-semibold text-[#0048FF]">
          Be part of HawkStack
        </h2>
        <p className="xl:mt-8 text-[#2F2F2F] font-medium xl:max-w-[64%] xl:text-xl">
          ...
          {filteredJobs.map((job, i) => (
            ...
            >
              ...
              <div className="max-w-2xl">
                <h3 className="text-[#0048FF] font-semibold xl:text-xl">
                  {job.title}
                </h3>
                ...
                <div className="flex gap-3 mt-6">
                  <button className="flex items-center gap-2 font-medium xl:px-4 xl:py-1.5 border border-[#2B2B2B] rounded-full xl:text-sm text-black hover:bg-gray-100">
