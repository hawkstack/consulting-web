  ...
  return (
    <section className="font-lexend">
      ...
      <div className="relative md:hidden">
        <Image
          src="/images/team-background.webp"
          alt={TITLE}
          width={1920}
          height={1080}
        ...
        <div className="absolute inset-0 pt-6 px-4 pointer-events-none">
          ...
          <h3 className="text-white mb-[16px] text-[12px]">{SUBTITLE}</h3>
          <Link href="/career">
            <button
      ...
      <div className="section-bg hidden md:block">
        <div className="pt-14 md:pt-20 lg:pt-25 px-4 md:px-12 lg:px-18 max-w-screen-xl">
          ...
          <h3 className="text-white mb-[30px] text-[24px]">{SUBTITLE}</h3>
          <Link href="/career">
            <button className="border border-white text-white rounded-2xl text-[16px] px-[24px] py-[12px] transition-colors hover:bg-white hover:text-black">
              {BUTTON_TEXT}
            </button>
          </Link>
        </div>
