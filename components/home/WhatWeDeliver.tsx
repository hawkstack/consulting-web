  ...
  return (
    <section className="min-h-[837px] pt-10 bg-gradient-to-b from-[#000000] to-[#04092E]">
      ...
      <div className="max-w-[1200px] mx-auto text-center px-4">
        ...
        <p className="font-lexend text-[16px] font-normal leading-[125%] tracking-[0] text-center max-w-[720px] mx-auto text-[#FFFFFF] mb-[50] mt-[10]">
        ...
        {deliverItems.map((item, index) => (
          ...
          >
            ...
            >
              ...
              {/* TITLE */}
              <h3 className="font-lexend text-[22px] font-medium leading-[27px] tracking-[-0.44px] mb-2 mx-[25] my-[40] text-[#FFFFFF] whitespace-nowrap">
                {item.title}
              </h3>
              ...
              <div className="mx-[25] mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <div className="flex items-end justify-between w-[342px]">
                  ...
                  <span className="inline-flex items-center justify-center w-[19px] h-[25px] text-[35px] leading-[24.92px] text-[#2E85FF]">
                    →
                  </span>
                </div>
              </div>
