        ...
        <div className="overflow-hidden px-[10px] py-[18px] md:rounded-[16px] md:border md:border-white/10 md:bg-[#202638] md:px-8 md:py-[40px] md:shadow-[0_22px_56px_rgba(0,0,0,0.28),inset_0_1px_0_rgba(255,255,255,0.05)] xl:rounded-none xl:border-0 xl:bg-transparent xl:px-[66px] xl:py-[52px] xl:shadow-none">
          <div className="mx-auto max-w-[1110px] xl:max-w-[1210px]">
            <div className="xl:flex xl:items-end xl:justify-start xl:gap-4">
              ...
              <div className="mt-[10px] flex justify-center md:mt-3 md:justify-start xl:mt-0 xl:mb-1 xl:self-end xl:justify-start">
                <Link
                  href={content.ctaHref}
                  className="inline-flex min-h-[40px] items-center justify-center rounded-full border border-[#1B5E7A] bg-[#0D3046] px-4 text-center text-[10px] font-semibold leading-[1.2] tracking-[-0.02em] text-[#A5F3FC] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] transition-colors hover:bg-[#123A54] md:min-h-[38px] md:px-[18px] md:text-[9px] xl:min-h-[34px] xl:py-[12px] xl:text-[14px]"
                >
                  {content.ctaLabel}
                </Link>
              </div>
