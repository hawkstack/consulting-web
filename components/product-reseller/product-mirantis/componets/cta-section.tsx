...
export default function ProductMirantisCtaSection({
  ...
  return (
    <section className="bg-white px-4 pb-10 pt-12 font-lexend text-white sm:px-8 md:pb-12 lg:px-10 lg:pb-14">
      <div className="mx-auto max-w-[454px] rounded-[14px] bg-[#102967] px-7 py-6 text-center sm:max-w-[640px] sm:rounded-[16px] sm:px-8 sm:py-8 md:max-w-[1120px] md:px-9 md:py-8 lg:max-w-[1280px] lg:rounded-[18px] lg:px-12 lg:py-10">
        <h2 className="mx-auto max-w-[1100px] text-[17px] font-semibold leading-[1.15] sm:text-[19px] md:text-[26px] lg:text-[32px]">
          {content.title}
        </h2>
