...
return (
    <section className=" w-full font-lexend py-10 lg:py-18 px-4 md:px-10 xl:px-18 overflow-hidden z-0">
        <div className="max-w-[1200px] mx-auto ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-3 md:max-w-[650px] lg:max-w-[1030px] mx-auto items-center md:items-start">
                    {content.items.map((item) => (
                        <div key={item.id} className="bg-[#FFFFFF] px-4 py-8 md:px-5 rounded-4xl border border-[#64748B]/80 items-stretch h-full flex flex-col">
